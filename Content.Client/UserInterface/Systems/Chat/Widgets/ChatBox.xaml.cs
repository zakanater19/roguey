...
public partial class ChatBox : UIWidget
{
    ...
    private int _lastStatusSecond = -1;
    ...
    public ChatBox()
    {
        ...
        StatusTabs.SetTabTitle(0, Loc.GetString("hud-status-tab-title"));
    ...
    public void UpdateStatus(DayNightCalendarTime calendar)
    {
        var currentSecond = (int) calendar.TimeOfDay.TotalSeconds;
        if (_lastStatusSecond == currentSecond)
            return;

        _lastStatusSecond = currentSecond;
        DayLabel.Text = Loc.GetString("hud-status-day", ("day", calendar.Day));
        TimeLabel.Text = Loc.GetString("hud-status-time",
            ("time", $"{calendar.TimeOfDay.Hours:00}:{calendar.TimeOfDay.Minutes:00}"));
    }
